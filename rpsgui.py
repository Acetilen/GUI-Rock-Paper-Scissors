...
#Для картинок
rock_image = PhotoImage(file=r"GUI rock paper scissors\stone1.png")
paper_image = PhotoImage(file=r"GUI rock paper scissors\paper1.png")
scissors_image = PhotoImage(file=r"GUI rock paper scissors\scissor1.png")
nothing_image = PhotoImage(file=r"GUI rock paper scissors\question1.png")
cpic = Canvas(width=105, height=105)
cpic.grid(column=1,row=0)
cpic.create_image(0, 0, image=nothing_image, anchor= NW)
ppic = Canvas(width=105, height=105)
